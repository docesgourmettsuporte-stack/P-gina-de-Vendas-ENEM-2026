      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <p className="text-slate-300 text-base sm:text-lg">
            Ao garantir o seu acesso hoje pelo valor promocional de <strong className="text-amber-400">R$ 27,90</strong>, você leva gratuitamente estes 6 materiais avaliados em mais de <span className="line-through text-slate-400">R$ 105,40</span>:
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-14">
          {BONUSES.map((bonus, index) => {
            ...
            return (
              <div
                key={bonus.id}
                className="relative rounded-2xl bg-slate-900/90 border border-slate-800 p-6 sm:p-7 flex flex-col justify-between hover:border-amber-500/40 hover:shadow-[0_8px_25px_rgba(245,158,11,0.1)] transition-all duration-300 group"
              >
                {bonus.highlightTag && (
                  <div className="absolute -top-3 right-5 bg-gradient-to-r from-amber-500 to-orange-500 text-slate-950 text-[10px] font-black uppercase px-2.5 py-0.5 rounded-full shadow-md">
                    ⭐ {bonus.highlightTag}
                  </div>
                )}
        ...
        <div className="bg-gradient-to-r from-amber-500/20 via-slate-900 to-orange-500/20 border border-amber-500/40 rounded-3xl p-6 sm:p-8 text-center max-w-4xl mx-auto shadow-2xl">
          ...
          <div className="text-2xl sm:text-3xl font-black text-white mb-2">
            Guia Principal + 6 Bônus Exclusivos = <span className="line-through text-rose-400">R$ 155,30</span>
          </div>
          ...
          >
            ...
            <span>QUERO GARANTIR TODOS OS 6 BÔNUS AGORA</span>
